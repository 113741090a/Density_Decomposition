...
int main(int argc,char** argv){
  ...
  int flag_increase = 1;
  //vector<string> algos = {"PR_exp", "FISTA*", "PR", "PR_lin", "Greedy++", "Elist++"};
  vector<string> algos = {algo_name};
  
  rep = 1;
  string folder_name = "data_hyper_mem/";
  string file_name_cpp = "";
  const char* file_name_c;
  string time_name = "_mem.txt";
  FILE *file_time;
  ...
  for (const std::string& algo_name : algos) {
    ...
    file_name_cpp = folder_name + algo_name + time_name;
