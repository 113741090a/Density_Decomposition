...
#algo_list = [ "FISTA", "FW_Elist", "PR", "PR_lin", "Greedypp", "Elistpp","PR_exp_pro"] "Greedy++",  "PR", "PR_lin", 
algo_names = ["FISTA*", "Elist++","PR_exp"]
...
algo_list = ["FISTA*",  "Elist++",  "PR_exp"]
#algo_list = ["FISTA", "Greedy++", "Elist++", "PR", "PR_lin", "PR_exp"] "Greedy++", "PR", "PR_lin",
